    ...
    <div class="row">
        <div class="col-3 border border-primary  overflow-scroll message-inbox-block me-5">
            <c:forEach var="message" items="${messageList}" varStatus="status">
                <div class="row">
                    <div class="col">
                        <a href="${contextPath}/messages/p/${message.messageProject.id}" class="text-decoration-none text-body">

                            <div class="card">

                                <small class="visually-hidden">${message.messageProject.id}</small>
                                <div class="card-header">
                                    Project: ${message.messageProject.project.title}
                                </div>
                                <div class="card-body">
                                    <h5 class="card-title">${message.messageProject.project.author.firstName}</h5>
